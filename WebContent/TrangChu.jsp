					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<input id="sDt" name="sdt" class="form-control" placeholder="SĐT"
										require="">
								</div>
								<div class="form-group">
									<input id="DChi" name="diaChi" class="form-control" placeholder="Địa chỉ"
										require="">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input id="MK" name="mK" class="form-control" placeholder="Mật khẩu"
										required="">
								</div>
								<div class="form-group">
        ...
        <h3>SẢN PHẨM BÁN CHẠY</h3>
            <section class="ShowSP">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                                <div class="card">
                                        <img class="card-img-top" src="./img/hamChicken.png" alt="Card image" >
                                        <div class="card-body">
                                            <h4 class="card-title" style="margin-bottom:40px;">Burger Gà</h4>
