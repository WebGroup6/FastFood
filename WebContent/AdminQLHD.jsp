    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div id="Admin">
                ...
                <a href=""data-toggle="modal" data-target="#myModalExit" >
                    <button type="button" class="btn btn-default btn-sm">
            ...
            <div class="modal-dialog-exit" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="AgreeExit()">Có</button>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <div>
                        <h1 class="sub-header" style=>DANH SÁCH HÓA ĐƠN</h1>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
	                			...
	                			<tr>
			                    	...
			                    	<td  width="75px">
			                    		<a class="edit" data-toggle="modal" data-target="#ModalSua">
		                                        <span class="glyphicon glyphicon-edit"></span></a>
		                                <a class="delete" data-toggle="modal" data-target="#myModalXoaHD">
                ...
                <div class="container">
                    <div class="modal fade" id="myModalHD1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true">
                    ...
                    <div class="modal fade" id="myModalHD2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <div class="modal fade" id="myModalHD3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <div class="modal fade" id="myModalHD4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
